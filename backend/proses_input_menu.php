    ...
    if ($statusUpload == 0) {
        ...
        window.location="../frontend/menu"</script>';
            ...
            if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
                $query = mysqli_query($conn, "INSERT INTO menu (foto,nama_menu,keterangan,kategori,harga,stok) values('" . $kode_rndm . $_FILES["foto"]["name"] . "','$nama_menu','$keterangan','$kat_menu','$harga','$stok')");
                if ($query) {
